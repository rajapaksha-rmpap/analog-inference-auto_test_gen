...
27:MOV,r453,905 # # store proc3 start loc
28:MOV,r463,905 # # store proc3 last loc  
29:NOP #
30:NOP #
31:NOP #
32:NOP #
...
958:OR,r196,r196,r480 # 
959:MOV,r235,1 # 
960:MOV,r480,0 # 
961:LLSHIFT,r480,r480,16 # 
962:OR,r235,r235,r480 # 
963:MOV,r216,0 # 
964:MOV,r238,65048 # 
965:MOV,r480,799 # 
966:LLSHIFT,r480,r480,16 # 
967:OR,r238,r238,r480 # 
968:MOV,r239,65052 # 
969:MOV,r480,799 # 
970:LLSHIFT,r480,r480,16 # 
971:OR,r239,r239,r480 # 
972:LOAD,r238,r236 ##Start INIT_WRITE_DATA_STRUCT 
973:LOAD,r239,r237 ##End INIT_WRITE_DATA_STRUCT
974:MOV,r225,128 # 
975:MOV,r480,784 # 
976:LLSHIFT,r480,r480,16 # 
977:OR,r225,r225,r480 # 
978:MOV,r480,0 # # start STORE_TO_MEMORY 
979:STORE,r225,r480 # # end STORE_TO_MEMORY - write data to address
980:MOV,r193,64 # 
981:MOV,r194,8 # 
982:MOV,r233,132 # 
983:MOV,r480,4280 # 
984:LLSHIFT,r480,r480,16 # 
985:OR,r233,r233,r480 # 
986:MOV,r250,224 # 
987:MOV,r480,0 # 
988:LLSHIFT,r480,r480,16 # 
989:OR,r250,r250,r480 # 
990:MOV,r227,0 # 
991:MOV,r480,4280 # 
992:LLSHIFT,r480,r480,16 # 
993:OR,r227,r227,r480 # 
994:MOV,r228,4 # 
995:MOV,r480,4280 # 
996:LLSHIFT,r480,r480,16 # 
997:OR,r228,r228,r480 # 
998:MOV,r242,140 # 
999:MOV,r480,4280 # 
1000:LLSHIFT,r480,r480,16 # 
1001:OR,r242,r242,r480 # 
1002:MOV,r243,52 # 
1003:MOV,r480,4280 # 
1004:LLSHIFT,r480,r480,16 # 
1005:OR,r243,r243,r480 # 
1006:MOV,r244,136 # 
1007:MOV,r480,4280 # 
1008:LLSHIFT,r480,r480,16 # 
1009:OR,r244,r244,r480 # 
1010:MOV,r245,28 # 
1011:MOV,r480,4280 # 
1012:LLSHIFT,r480,r480,16 # 
1013:OR,r245,r245,r480 # 
1014:MOV,r251,48 # 
1015:MOV,r480,4280 # 
1016:LLSHIFT,r480,r480,16 # 
1017:OR,r251,r251,r480 # 
1018:MOV,r246,32 # 
1019:MOV,r480,4280 # 
1020:LLSHIFT,r480,r480,16 # 
1021:OR,r246,r246,r480 # 
1022:MOV,r247,36 # 
1023:MOV,r480,4280 # 
1024:LLSHIFT,r480,r480,16 # 
1025:OR,r247,r247,r480 # 
1026:MOV,r248,40 # 
1027:MOV,r480,4280 # 
1028:LLSHIFT,r480,r480,16 # 
1029:OR,r248,r248,r480 # 
1030:MOV,r249,44 # 
1031:MOV,r480,4280 # 
1032:LLSHIFT,r480,r480,16 # 
1033:OR,r249,r249,r480 # 
1034:MOV,r483,1 # 
1035:STORE,r227,r483 # 
1036:MOV,r483,2 # 
1037:STORE,r251,r483 # 
1038:MOV,r483,0 # 
1039:STORE,r243,r483 # 
1040:MOV,r484,82 # 
1041:STORE,r244,r484 ##End SET_PCI_DMA_REGS 
1042:MOV,r234,1 # 
1043:MOV,r252,1 # 
1044:MOV,r197,0 # 
1045:MOV,r198,8 # 
...
1050:MOV,r204,1 # 
1051:MOV,r206,16384 # 
1052:MOV,r207,67108124 # 
1053:ADDI,r197,r197,1 # 
1054:MOV,r200,1 # 
1055:ADDI,r194,r195,0 # 
1056:SUB,r195,r195,r200 # 
1057:BRAGEZ,2 # 
1058:ADDI,r194,r200,0 # 
1059:MOV,r208,1 # 
1060:ADDI,r196,r209,0 # 
1061:ADDI,r236,r210,0 # 
1062:ADDI,r208,r211,0 # 
1063:MOV,r193,64 # 
1064:SUBI,r195,r195,0 # 
1065:BRAGEZ,2 # 
1066:MOV,r193,0 # 
1067:SUBI,r211,r211,1 # 
1068:BRALEZ,2 # 
1069:BRAUNCOND,5 # 
1070:MOV,r193,64 # 
1071:SUBI,r195,r195,0 # 
1072:BRAGEZ,2 # 
1073:MOV,r193,0 # 
1074:ADDI,r199,r482,84 ## Start START_INPUT_TFR_LAYER_CHECK 
1075:OR,r482,r482,r492 # 
1076:STORE,r482,r200 # # writre to ib_decr_reg
1077:OR,r199,r481,r492 # 
1078:ADDI,r481,r482,88 # 
1079:LOAD,r482,r483 # # read ib_cntr_reg 
1080:SUB,r483,r482,r200 # 
1081:BRAGEZ,4 # 
1082:MOV,r463,1024 # 
1083:MOV,r449,4 # 
1084:BRAUNCOND,-1021 # 
1085:OR,r199,r481,r492 # 
1086:ADDI,r481,r482,104 # 
1087:LOAD,r482,r483 # #read ob_cntr_reg 
1088:ADDI,r481,r482,96 # 
1089:LOAD,r482,r484 # # read ob_full_lvl_reg 
1090:SUB,r484,r482,r483 # 
1091:SUB,r482,r482,r200 # 
1092:BRAGEZ,4 # 
1093:MOV,r463,1035 # 
1094:MOV,r449,4 # 
1095:BRAUNCOND,-1032 ## End START_INPUT_TFR_LAYER_CHECK 
1096:MOV,r211,1 # 
1097:ADDI,r209,r215,0 # 
1098:MOV,r486,16383 # 
1099:AND,r215,r215,r486 # 
1100:ADDI,r215,r213,0 # 
1101:ADD,r213,r213,r193 # 
1102:SUB,r213,r213,r206 # 
1103:BRALEZ,2 # 
1104:BRAUNCOND,19 # 
1105:MOV,r481,1 # #Start START_EXTERNAL_IO 
1106:STORE,r242,r481 # 
1107:LOAD,r242,r481 # 
1108:STORE,r245,r193 # 
1109:STORE,r246,r209 # 
1110:STORE,r247,r235 # 
1111:STORE,r248,r210 # 
1112:STORE,r249,r237 # 
1113:MOV,r481,1 # 
1114:STORE,r228,r481 ##End START_EXTERNAL_IO 
1115:OR,r250,r250,r492 # #Start EXTERNAL_IO_DONE 
1116:LOAD,r250,r481 # 
1117:AND,r481,r481,r252 # 
1118:BRANZ,4 # 
1119:MOV,r463,1065 # 
1120:MOV,r449,4 # 
1121:BRAUNCOND,-1058 # End EXTERNAL_IO_DONE 
1122:BRAUNCOND,42 # 
1123:MOV,r217,16384 # 
1124:SUB,r217,r217,r215 # 
1125:MOV,r481,1 # #Start START_EXTERNAL_IO 
1126:STORE,r242,r481 # 
1127:LOAD,r242,r481 # 
1128:STORE,r245,r217 # 
1129:STORE,r246,r209 # 
1130:STORE,r247,r235 # 
1131:STORE,r248,r210 # 
1132:STORE,r249,r237 # 
1133:MOV,r481,1 # 
1134:STORE,r228,r481 ##End START_EXTERNAL_IO 
1135:OR,r250,r250,r492 # #Start EXTERNAL_IO_DONE 
1136:LOAD,r250,r481 # 
1137:AND,r481,r481,r252 # 
1138:BRANZ,4 # 
1139:MOV,r463,1085 # 
1140:MOV,r449,4 # 
1141:BRAUNCOND,-1078 # End EXTERNAL_IO_DONE 
1142:ADDI,r210,r218,0 # 
1143:ADD,r218,r218,r217 # 
1144:ADDI,r209,r219,0 # 
1145:MOV,r486,-16384 # 
1146:AND,r219,r219,r486 # 
1147:MOV,r481,1 # #Start START_EXTERNAL_IO 
1148:STORE,r242,r481 # 
1149:LOAD,r242,r481 # 
1150:STORE,r245,r213 # 
1151:STORE,r246,r219 # 
1152:STORE,r247,r235 # 
1153:STORE,r248,r218 # 
1154:STORE,r249,r237 # 
1155:MOV,r481,1 # 
1156:STORE,r228,r481 ##End START_EXTERNAL_IO 
1157:OR,r250,r250,r492 # #Start EXTERNAL_IO_DONE 
1158:LOAD,r250,r481 # 
1159:AND,r481,r481,r252 # 
1160:BRANZ,4 # 
1161:MOV,r463,1107 # 
1162:MOV,r449,4 # 
1163:BRAUNCOND,-1100 # End EXTERNAL_IO_DONE 
1164:ADDI,r209,r212,0 # 
1165:ADD,r212,r212,r193 # 
1166:MOV,r486,16383 # 
1167:AND,r212,r212,r486 # 
1168:MOV,r486,-16384 # 
1169:AND,r209,r209,r486 # 
1170:ADD,r209,r209,r212 # 
1171:ADD,r210,r210,r193 # 
1172:SUBI,r208,r208,1 # 
1173:BRALEZ,2 # 
1174:BRAUNCOND,-107 # 
1175:MOV,r214,1 # 
1176:ADDI,r200,r195,0 # 
1177:MOV,r205,1 # 
1178:OR,r202,r480,r492 # 
1179:STORE,r480,r214 # 
1180:MOV,r481,1028 # 
1181:OR,r481,r481,r492 # 
1182:STORE,r481,r198 # # End POP_SYNC - write to ib_decr_reg
1183:MOV,r481,1032 ## Start SEND_SYNC_PREV 
1184:OR,r481,r481,r492 # 
1185:STORE,r481,r198 ## End SEND_SYNC_PREV - write to asq_send_reg
1186:MOV,r482,1048 ## Start SEND_SYNC_NEXT 
1187:OR,r482,r482,r492 # 
1188:STORE,r482,r198 # # End SEND_SYNC_NEXT
1189:MOV,r481,1044 # # Start END_BLOCK_EXTERNAL 
1190:OR,r481,r481,r492 # 
1191:STORE,r481,r198 ## write to ob_incr_reg - End END_BLOCK_EXTERNAL 
1192:SUBI,r195,r195,1 # 
1193:BRALEZ,2 # 
1194:BRAUNCOND,-16 # 
1195:ADD,r236,r236,r193 # 
1196:ADD,r216,r216,r193 # 
1197:MOV,r486,16383 # 
1198:AND,r216,r216,r486 # 
1199:MOV,r486,-16384 # 
1200:AND,r196,r196,r486 # 
1201:ADD,r196,r196,r216 # 
1202:SUBI,r194,r194,1 # 
1203:BRALEZ,2 # 
1204:BRAUNCOND,-153 # 
1205:MOV,r220,8 # 
1206:MOV,r221,3 # 
...
1209:MOV,r225,128 # 
1210:MOV,r480,784 # 
1211:LLSHIFT,r480,r480,16 # 
1212:OR,r225,r225,r480 # 
1213:NOP ##Start SET_UP_NEXT 
1214:NOP # 
1215:NOP # 
1216:MOV,r463,914 # 
1217:MOV,r449,3 # 
1218:BRAUNCOND,-1155 # #Branch to the same layer, instruction start location
1219:NOP # 
1220:NOP # 
1221:NOP # 
1222:NOP # 
1223:HALT # 
1224:NOP ##End SET_UP_NEXT 
